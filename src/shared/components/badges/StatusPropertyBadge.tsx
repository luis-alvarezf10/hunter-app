...
export const StatusPropertyBadge: React.FC<StatusPropertyProp> = ({ status }) => {
  ...
  return (
    <span className={`px-3 py-1 text-xs font-medium tracking-wider rounded-lg text-white ${colorClass} transition-colors duration-300`}>
      {label}
    </span>
  );
};