export function SalesTable() {
  ...
  return (
    <div className="bg-white dark:bg-[#1a1a1a] border border-gray-300 dark:border-gray-600 text-black dark:text-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
