...
function DashboardLayoutContent({
  ...
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      <button
        className="lg:hidden fixed top-5 left-8 w-12 h-12 flex flex-col items-center justify-center gap-1.5 z-[60]  rounded-lg transition-colors hover:bg-white/30 dark:hover:bg-black/30 shadow-lg cursor-pointer"
